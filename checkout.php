...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Number:</span>
            <input type="number" name="number" required placeholder="+63**********">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Address:</span>
            <input type="text" name="street" required placeholder="lot, block, street, barangay, city">
         </div>
      </div>
